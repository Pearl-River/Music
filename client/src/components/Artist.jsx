  ...
  return (
    <div className='w-full flex items-center justify-center flex-col'>
      ...
      <div className='w-full flex justify-center py-5 items-center gap-20 pt-12'>
        <NavLink to={"/newArtistUser"} className='bg-white flex items-center justify-center px-4 py-3 border rounded-md border-gray-900 hover:border-gray-500 hover:shadow-md cursor-pointer'>
