...
const DashboardNewAlbum = () => {
  ...
  return (
    <div className='flex flex-col items-center justify p-4 border border-gray-500 gap-3 rounded'>
        <p className='text-xl font-semibold text-headingColor'>THÊM ALBUM</p>
        <input type="text" placeholder='Nhập tên Album...' className='w-full p-3 rounded-md text-base font-semibold text-textColor outline-none shadow-sm border border-gray-500'
