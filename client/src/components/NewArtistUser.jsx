...
const NewArtistUser = () => {
  ...
  return (
    <div className='flex flex-col items-center justify p-4 border border-gray-500 gap-3 rounded w-full'>
        <Header/>
    <p className='text-xl font-semibold text-headingColor pt-10'>THÊM CA SĨ</p>
    <input type="text" placeholder='Nhập tên ca sĩ...' className='w-880 p-3 rounded-md text-base font-semibold text-textColor outline-none shadow-sm border border-gray-500'
