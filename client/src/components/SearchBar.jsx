...
const SearchBar = () => {
  ...
  return (
    <div className="w-full my-4 h-16 bg-card flex items-center justify-center">
      <div className="w-full gap-4 p-4 md:w-2/3 bg-purple-100 border border-gray-900 shadow-xl mt-12 rounded-md flex items-center">
        ...
        <input
          ...
          placeholder="Nhập tên bài hát, ca sĩ bạn cần tìm ....."
